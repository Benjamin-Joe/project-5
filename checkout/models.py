...
# Order and orderlineitem class from boutique ado
class Order(models.Model):
    ...
    country = CountryField(blank_label='Countries', null=False, blank=False)
    ...
    def save(self, *args, **kwargs):
        "Override the save method to set order number if one doesn't exist"
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        "Override save method for lineitem total"
